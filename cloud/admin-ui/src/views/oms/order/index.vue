...
<!--      <el-table-column label="订单ID" align="center" prop="id" />-->
      ...
      <el-table-column label="物流状态" align="center" prop="logisticsStatus">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.oms_logistics_status" :value="scope.row.logisticsStatus"/>
        </template>
      </el-table-column>
      ...
      <!-- 订单商品详情弹框 -->
      <el-dialog title="订单商品详情" :visible.sync="orderItemDetailVisible" width="800px" append-to-body>
        <el-table :data="orderItemDetailList" v-loading="orderItemDetailLoading">
          ...
          <el-table-column label="商品名称" align="center" prop="cmsProduct.name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="用户ID" prop="userId">
          <el-select v-model="form.userId" placeholder="请选择商品分类">
            <el-option
        ...
        <el-form-item label="物流状态" prop="logisticsStatus">
          <el-select v-model="form.logisticsStatus" placeholder="请选择物流状态">
            <el-option
              v-for="dict in dict.type.oms_logistics_status"
              :key="dict.value"
              :label="dict.label"
              :value="parseInt(dict.value)"
            ></el-option>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        userAddress: [
          { required: true, message: "用户收货地址不能为空", trigger: "blur" }
        ],
        createTime: [
