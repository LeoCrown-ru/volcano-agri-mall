...
<!--      <el-table-column label="促销ID" align="center" prop="id" />-->
      ...
      <el-table-column label="促销类型" align="center" prop="type">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.cms_promototion_type" :value="scope.row.type"/>
        </template>
      </el-table-column>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="促销类型" prop="type">
          <el-select v-model="form.type" placeholder="请选择促销类型">
            <el-option
              v-for="dict in dict.type.cms_promototion_type"
              :key="dict.value"
              :label="dict.label"
    ...
    <!-- 分配商品弹框1 -->
    <el-dialog title="分配商品" :visible.sync="distributeDialogVisible" width="800px" append-to-body>
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            type="primary"
    ...
    <!-- 新增商品弹框2 -->
    <el-dialog title="选择商品" :visible.sync="addProductDialogVisible" width="800px" append-to-body>
      <el-table
...
export default {
  ...
  data() {
    return {
      ...
      currentProductList: [], // 当前促销活动的商品列表
