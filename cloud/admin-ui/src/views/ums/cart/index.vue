...
<!--          >修改</el-button>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="" prop="userId">
          <el-button type="primary" size="mini" @click="openProductDialog">新增商品</el-button>
        </el-form-item>

        <el-form-item label="商品列表" prop="productList">
          <el-table :data="form.productList" border>
            <el-table-column label="商品名称" prop="name" align="center"/>
            <el-table-column label="商品数量" width="250" align="center">
              <template slot-scope="scope">
                <el-input-number
    ...
    <!-- 全部商品弹框 -->
    <el-dialog title="选择商品" :visible.sync="productDialogVisible" width="800px" append-to-body>
    ...
    <!-- 商品详情弹框 -->
    <el-dialog title="商品详情" :visible.sync="productDetailVisible" width="800px" append-to-body>
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        userId: null,
        productList: [], // 商品列表，包含商品ID、名称、数量和库存
      },
      // 商品详情加载状态
